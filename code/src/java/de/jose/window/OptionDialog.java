...
//		                                JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
		...
		p2.setBorder(new TitledBorder(Language.get("plugin.maxdepth")));

		JSlider slider = createEngineDepthSlider("plugin.maxdepth");
		slider.addChangeListener(this);
		//addWithLabel(p1, 1, "plugin.engine.depth", slider);
		reg(slider);
		p2.add(slider, BorderLayout.CENTER);
		//System.out.println ("initTab4: slider.getName: " + slider.getName());
		//System.out.println ("initTab4: getElement(plugin.maxdepth): " + getElement("plugin.maxdepth"));
		//System.out.println ("initTab4: getElement(plugin.args): " + getElement("plugin.args"));
		//setIntValue ("plugin.maxdepth", 19);
		//slider.setValue (19);
	...
	private static JSlider createEngineDepthSlider(String name)
	{
		JSlider slider = new JSlider(1,30);
		slider.setName(name);

		//When GTK style is active, the slider should NOT be inverted
		String lnfClassName = Application.theUserProfile.getString("ui.look.and.feel");
		//String lnfClassName = Version.getSystemProperty("jose.look.and.feel");
		System.out.println("lnfClassName: " + lnfClassName);
		if (Pattern.matches(".*GTK.*", lnfClassName)) {		
		...
		labels.put(new Integer(30), new JLabel("max"));
...
//		compTitle = makeHtmlLabel(compTitle);
	...
	Integer maxdepth = EnginePlugin.getMaxDepth(cfg);
	System.out.println ("setPluginInfo: retrieved value for maxdepth: " + maxdepth);
	...
	setValueByName("plugin.maxdepth", maxdepth);
...
//System.out.println(cfg.toString());
		...
		Integer maxdepth = (Integer)getIntValue("plugin.maxdepth");
		System.out.println ("readPluginInfo: Setting maxdepth to " + maxdepth);
		if (EnginePlugin.setMaxDepth(cfg,maxdepth)) dirty = true;
		System.out.println ("readPluginInfo: Value of  dirty " + dirty);
