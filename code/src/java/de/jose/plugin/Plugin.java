		...
		implements InputListener
{
	...
	public static Integer getMaxDepth (Element config) { 
		return XMLUtil.getChildIntValue(config,"MAXDEPTH"); 
	}

	public Integer getMaxDepth () { 
		return getMaxDepth (config); 
	}

	public static boolean setMaxDepth (Element config, Integer value) { 
		return XMLUtil.setChildValue(config,"MAXDEPTH",value); 
	}
